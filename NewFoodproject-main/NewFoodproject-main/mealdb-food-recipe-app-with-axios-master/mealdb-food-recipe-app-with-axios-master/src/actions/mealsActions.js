...
import {
    FETCH_CATEGORY_BEGIN,  //เอาข้อมูลจาก api มาจากไฟล์ แอกซิออส 
...
import { CATEGORIES_URL, MEAL_CATEGORIES_URL, MEAL_SINGLE_URL, SEARCH_URL } from "../utils/constants"; //import มาจากเว็บไซต์

export const startFetchCategories = async(dispatch) => { //ตรวจสอบค่าของแต่ละตัว
    try{
